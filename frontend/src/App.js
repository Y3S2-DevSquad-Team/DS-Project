    ...
    <Router>
      ...
      <div className="mt-10">
        <Routes>
          ...
          <Route path="/driver/profile" element={<DeliveryPersonProfile />} />
          <Route
            path="/delivery/request"
            element={<RequestDeliveryPage />}
          />{" "}
          {/*/ vilan mock driver locations*/}
          <Route
            path="/delivery/track/:orderId"
            element={<TrackDeliveryPage />}
          />
          <Route
            path="/driver/:driverId/deliveries"
            element={<DriverDeliveriesPage />}
          />
          <Route
            path="/driver/:driverId/update-location"
            element={<UpdateDriverLocationPage />}
          />
          <Route
            path="/driver/:driverId/delivery/:deliveryId/update-status"
            element={<UpdateDeliveryStatusPage />}
          />
          <Route path="/driver/navigate/:id" element={<NavigationPage />} />
          <Route path="/driver/pickup/:id" element={<PickupPage />} />
          <Route
            path="/driver/deliver/:id"
            element={<DeliverToCustomerPage />}
          />
          <Route
